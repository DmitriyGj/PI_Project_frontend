...
const initialState: MeetingState = { meetings : [
    { id: 1, name:'name1', invoker: 'invoker1', place:'place1', progectName:'progect1', dateTimeStart: new Date(2021, 12,31, 2,2), dateTimeEnd: new Date(2022, 1,5,4,44) },
    ...
    { id: 4, name:'name4', invoker: 'invoker4', place:'place4', progectName:'progect4', dateTimeStart: new Date(2022, 5,2, 7,33), dateTimeEnd: new Date(2022, 5,3,8,5) }
