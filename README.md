...
5. В случае хуков типы можно писать вместе с хуком, не нужно их выносить в отдельный файл, но если вы это сделали, то будьте добры экспортировать это через index.ts соответственно вместе с хуком
6. Пиветствуется дефолтный экспорт **НО** в корневом файле папки должно быть наименование через as 
7. По-максимуму используем возможности библиотеки [classNames](https://www.npmjs.com/package/classnames)  
8. Важно не забывать про module при создании файлов, т.к. в них создаются захешированные названия стилей, чтоб они  
